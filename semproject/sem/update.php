<?php
 ...
 if(isset($_POST['submit'])){
   ...
   $sql="update crud set id=$id, fname='$fname', lname='$lname', address='$address', number='$number',  email='$email', roll='$roll', password='$password' where id=$id";
   // echo "$fname";
   $result=mysqli_query($con, $sql);
   if($result){
...
<html>
   ...
   <div class="form-container">
      ...
      <div class="inputs">
         <label class="inn">User Role:</label><br>
         <select name="roll", id="roll">
            <option value="1">Owner</option>
            <option value="2">Renter</option>
            <option value="0" hidden>Admin</option>
         </select>
         <!-- <input type="radio" name="o_r" id="ownr" >Owner
         <input type="radio" name="o_r" id="owr" >Renter       -->
      <span id="err6"></span>
      </div>

      <div class="inputs">
         <label class="inn">Password:</label><br>
         <input type="password" name="password" id="pass" placeholder="******">
         <span id="err7"></span>
      </div>
      
      <div class="inputs">
         <label class="inn">Confirm Password:</label><br>
