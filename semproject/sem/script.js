...
function  validateForm(){
   returnval=true;
   // let correct_num=/\d/;
   // let correct_way= /^[a-zA-Z]{2,}$/;
   // let correct_email=/^[a-z\._\-[0-9]*[@][a-z]*[\.][a-z]{2,4}$/;
   // let correct_password=/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/;
...
//    ae.innerHTML="Only alphabets allowed";
//    returnval= false;
// }
if(a.length>20){
   ae.innerHTML="Must contain more than 3 letter";
   returnval = false;
}
if(a==""){
...
//Lasr name start=========================
if(b.length>20){
   be.innerHTML="Must contain more than 3 letter";
   returnval = false;
}
// if(!b.match(correct_way)){
//    be.innerHTML="Only alphabets allowed";
//    returnval= false;
// }
if(b==""){
...
if(c.length>20){
   ce.innerHTML="Must contain more than 3 letter";
   returnval = false;
}
// if(!c.match(correct_way)){
//    ce.innerHTML="Only alphabets allowed";
//    returnval= false;
// }
if(c==""){
...
//    ge.innerHTML="Enter at least one special character";
//    returnval=false;
// }
...
//    returnval=false;
// }
// if(!g.match(correct_num)){
//    ge.innerHTML="At least one digit";
//    returnval=false;
// }
if(g==""){
